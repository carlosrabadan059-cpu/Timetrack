...
import vacacionesRoutes, { adminVacaciones } from './api/routes/vacaciones.js';
...
app.route('/api/me/vacaciones', vacacionesRoutes);
app.route('/api/vacaciones', adminVacaciones);
